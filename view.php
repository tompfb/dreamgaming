...
<head>
    ...
    <meta property="og:url" content="https://www.dreamgaming-789.com/view/<?php echo $encode ?>" />
    <meta property="og:site_name" content="dream gaming" />

    <meta property="twitter:url" content="https://www.dreamgaming-789.com/view/<?php echo $encode ?>">
    ...
    <link rel="alternate" href="https://www.dreamgaming-789.com/<?php echo $encode ?>" hreflang="th-TH" />
    <link rel="canonical" href="https://www.dreamgaming-789.com/<?php echo $encode ?>" />
    ...
    <script type="application/ld+json">
        {
            ...
            "mainEntityOfPage": {
                "@type": "WebPage",
                "@id": "https://www.dreamgaming-789.com/view/<?php echo $encode ?>"
            },
            "headline": "<?php echo $topic_name  ?>",
            "image": [
                "https://www.dreamgaming-789.com/backend/uploads/article-img/<?php echo $image_banner  ?>"
            ],
            ...
            "author": {
                "@type": "Person",
                "name": "dream gaming",
                "url": "https://www.dreamgaming-789.com/view/<?php echo $encode ?>"
            },
            "publisher": {
                "@type": "Organization",
                "name": "dream gaming",
    ...
    <script type="application/ld+json">
        {
            ...
            "itemListElement": [{
                ...
                "position": 1,
                "name": "หน้าแรก",
                "item": "https://www.dreamgaming-789.com/"
            }, {
                "@type": "ListItem",
                "position": 2,
                "name": "บทความทั้งหมด",
                "item": "https://www.dreamgaming-789.com/all-articles/"
            }],
            {
                "@type": "ListItem",
                "position": 3,
